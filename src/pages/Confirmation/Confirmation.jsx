...
function Confirmation() {
    return (
        <div className='background'>
            <LogSignContainer first_card={<ConfirmCard title={title} desc={desc} green_button={not_green_button} not_green_button={green_button} button_one={button_one} button_two={button_two} />} sec_card={<BarcodeContainer />} />
